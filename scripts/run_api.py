...
The root page provides an answer-verification dashboard.
The /docs page retains the full interactive Swagger UI.
"""
import sys, os
...
if __name__ == "__main__":
    ...
    print(f"[API] Dashboard → http://localhost:{config.API_PORT}")
